...
///
/// To show the [RadioListTileSuper] as disabled, pass null as the [onChanged]
/// callback.
///
...
class RadioListTileSuper<T> extends StatelessWidget {
  ...
  /// If specified, [shape] defines the shape of the [RadioListTileSuper]'s [InkWell] border.
  final ShapeBorder shape;

  /// If specified, defines the background color for `RadioListTile` when
  /// [RadioListTileSuper.selected] is false.
  final Color tileColor;

  /// If non-null, defines the background color when [RadioListTileSuper.selected] is true.
